...
//                .addClaims(map)
    ...
    public void testParseTokenByClaims(){
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI4ODg4Iiwic3ViIjoiUm9zZSIsImlhdCI6MTY0NTg0NzczOSwicm9sZXMiOiJhZG1pbiIsImxvZ28iOiJ4eHguanBnIn0.7OJH7qm_Fu886YePRZP1uv9g4sTFiziGFjKhP_udYa0";
        Claims claims = Jwts.parser()
                .setSigningKey("xxxx")
                .parseClaimsJws(token)
                .getBody();
